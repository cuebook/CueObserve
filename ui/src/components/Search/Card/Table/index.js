...
export default function TableCard(props) {
	...
	const dataTable = <Table className={style.antdTable} columns={columns} dataSource={data ? styledTable.source : data} pagination={false} size="xs" bordered={true} scroll={{ x: data ? 1200 : styledTable.tableWidth, y: 120 }} />
